...
const EP_InternshipDetailsPage = () => {
  ...
  const handleEditInternship = () => {
    navigate(`/employer/edit-internship/${jobId}`);
  };
        ...
        <div className={styles.jobSummary}>
          <div className={styles.jobInfo}>
            ...
            <div className={styles.infoItem}>
              ...
              <span>SGD {jobDetails.stipend}/month</span>
            </div>
            {jobDetails.duration && (
              <div className={styles.infoItem}>
...
export default EP_InternshipDetailsPage;