...
export default function JobSeekerAdhocDetailsPage() {
  const { id } = useParams();
    ...
    return (
      <>
        ...
        <div className="error-container">
          ...
          <Link to="/jobseeker/find-adhoc" className="back-btn">
            Back to Listings
          </Link>
        </div>
      </>
      ...
      {showApplyModal && (
        <div className="modal-overlay">
          <div className="modal-container">
            ...
            <p>Are you sure you want to apply for this ad-hoc position at {job.company}?</p>
