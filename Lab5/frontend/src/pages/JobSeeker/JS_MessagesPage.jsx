              ...
              <div className="text-center w-full">
                ...
                <div className="bg-purple-100 p-4 rounded-lg border border-purple-200 mb-4 max-w-lg mx-auto">
                  ...
                  <div className="flex flex-wrap gap-2 text-sm">
                    <span className="bg-purple-200 text-purple-700 px-2 py-1 rounded-full">Resume Analysis</span>
                    <span className="bg-purple-200 text-purple-700 px-2 py-1 rounded-full">Job Recommendations</span>
                    <span className="bg-purple-200 text-purple-700 px-2 py-1 rounded-full">Interview Prep</span>
                    <span className="bg-purple-200 text-purple-700 px-2 py-1 rounded-full">Career Guidance</span>
                    <span className="bg-purple-200 text-purple-700 px-2 py-1 rounded-full">Skill Development</span>
                  </div>
                </div>
...
export default JS_MessagesPage;